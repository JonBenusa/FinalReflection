...
void Init_LED(void){
	...
	GPIOD->MODER|=((1<<2*LED_ORANGE)|(1<<2*LED_GREEN)|(1<<2*LED_RED)|(1<<2*LED_BLUE));
}
...
void EXTI0_IRQHandler(void){	
	...
	GPIOD->BSRR = ((1<<(LED_ORANGE+16))|(1<<(LED_GREEN))|(1<<(LED_RED))|(1<<(LED_BLUE+16)));
}
...
//	while(1)
//		{
//			GPIOD->BSRR = ((1<<(LED_ORANGE+16))|(1<<(LED_GREEN+16))|(1<<(LED_RED+16))|(1<<(LED_BLUE+16)));
//			GPIOD->BSRR = ((1<<(LED_ORANGE)) |(1<<(LED_BLUE)));
//			for(j=0; j<500000;j++){};
//			GPIOD->BSRR = ((1<<(LED_ORANGE+16)) |(1<<(LED_BLUE+16)));
//			for(j=0; j<500000;j++){};
//		}
//}
